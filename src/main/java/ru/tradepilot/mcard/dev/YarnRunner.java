package ru.tradepilot.mcard.dev;
...
public class YarnRunner implements CommandLineRunner {
    ...
    private void startFrontend() throws InterruptedException, IOException, TimeoutException {
        File frontendDir = locate("./frontend/package.json", "../fontend/package.json");
